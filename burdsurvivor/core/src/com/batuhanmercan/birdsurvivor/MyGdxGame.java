package com.batuhanmercan.birdsurvivor;
		...
		batch.draw(background,0,0, Gdx.graphics.getWidth(),Gdx.graphics.getHeight());
		 ...
		 if (gameState==1){
			 ...
			 for (int i = 0; i < numberOfEnemies; i++ ) {
				 ...
				 batch.draw(monster1,enemyX[i],Gdx.graphics.getHeight()/2 + enemyOffSet[i],Gdx.graphics.getWidth()/15,Gdx.graphics.getHeight()/10);
